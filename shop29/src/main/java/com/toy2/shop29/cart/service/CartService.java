...
public interface CartService {
    ...
    // 장바구니에 상품 추가
    void addProductToCart(String userId, Long productId, Long quantity, Long productOptionId, int is_user) throws Exception;

    int updateProductQuantity(String userId, Long productId, Long quantity, Long productOptionId) throws Exception;
