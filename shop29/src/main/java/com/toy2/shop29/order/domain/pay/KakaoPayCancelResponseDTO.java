...
public class KakaoPayCancelResponseDTO {
    ...
    private AmountDetail approved_cancel_amount;    // 이번 요청으로 취소된 금액
    private AmountDetail canceled_amount;           // 누계 취소 금액
    private AmountDetail cancel_available_amount;   // 남은 취소 가능 금액
