...
public class MiddleCategoryDto {
    ...
    public MiddleCategoryDto(int middle_category_id, int major_category_id, String middle_category_name, Date created_date, String created_id, Date updated_date, String updated_id) {
    ...
    public boolean equals(Object o) {
        ...
        MiddleCategoryDto that = (MiddleCategoryDto) o;
        return middle_category_id == that.middle_category_id && major_category_id == that.major_category_id && Objects.equals(middle_category_name, that.middle_category_name) && Objects.equals(created_id, that.created_id) && Objects.equals(updated_id, that.updated_id);
    }

    @Override
    public int hashCode() {
        return Objects.hash(middle_category_id, major_category_id, middle_category_name, created_id, updated_id);
    }
